...
=====帮助说明=====
#获取最上级帮助
PS C:\Users\Administrator> docker --help
#获取特定命令帮助
PS C:\Users\Administrator> docker run --help
PS C:\Users\Administrator> docker ps --help
=====实际操作演示=====
#拉取docker镜像，并制定镜像版本
PS C:\Users\Administrator> docker pull mysql:5.7.24
#查询现有的docker镜像image
PS C:\Users\Administrator> docker images
PS C:\Users\Administrator> docker image ls
#查询现有的全部docker容器container
PS C:\Users\Administrator> docker ps -a
#查询现有的正在运行的docker容器container
PS C:\Users\Administrator> docker container ls
######创建容器及其初始化操作######
PS C:\Users\Administrator> docker run --name mysql -p 3306:3306 -e MYSQL_ROOT_PASSWORD=123456 -d mysql:5.7.24
PS C:\Users\Administrator> docker container ls
PS C:\Users\Administrator> docker ps
# 停止正在运行的容器
PS C:\Users\Administrator> docker stop mysql
PS C:\Users\Administrator> docker container ls
# 启动容器
PS C:\Users\Administrator> docker start mysql
```
...
>
> [Docker安装mysql 配置远程登录](https://blog.csdn.net/smartdt/article/details/78126324)
>
> ## 使用mysql镜像
>
> ### 运行容器
...
$ docker run --name mysql5.7.24 -e MYSQL_ROOT_PASSWORD=123456@ -d mysql:5.7.24
...
[![img](assets/button.png)](http://play-with-docker.com/?stack=https://raw.githubusercontent.com/docker-library/docs/b664a62bb7be3e0cbc2304e306ea42f33244fad1/mysql/stack.yml)

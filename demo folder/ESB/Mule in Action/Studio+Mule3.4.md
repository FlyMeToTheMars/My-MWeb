[studio+mule3.4](http://studio.mulesoft.org/3.4/plugin)	

[studio + maven](https://docs.mulesoft.com/mule-runtime/3.6/configuring-maven-to-work-with-mule-esb)

`mvn install -D maven.test.skip=true`

`mvn eclipse:eclipse`

`import` -- `Generel` -- `Existing Projects into Workspace`
...
<settings xmlns="http://maven.apache.org/SETTINGS/1.0.0"
  ...
  <mirrors>
    ...
    <mirror> 
        ...
        <mirrorOf>codehaus-releases,codehaus,mule-deps</mirrorOf> 
    </mirror> 
    <mirror> 

...
| --------------------------- | ------------- | ---------- |
| `type name` | A type name, the basic building block of a type expression, used alone creates the simplest expression. | `number:` a built-in type `Person:` a custom type |

...
Now let’s use a transformation. We will use the [`filter`](http://spark.apache.org/docs/2.1.3/programming-guide.html#transformations) transformation to return a new RDD with a subset of the items in the file.
